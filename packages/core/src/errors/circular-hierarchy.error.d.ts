...
export declare class CircularHierarchyError extends RBACError {
    ...
    constructor(roleId: string, targetRoleId: string, chain: string[], context?: Partial<Omit<CircularHierarchyContext, 'roleId' | 'targetRoleId' | 'chain'>>);
    ...
    static maxDepthExceeded(roleId: string, chain: string[], maxDepth: number): CircularHierarchyError;
