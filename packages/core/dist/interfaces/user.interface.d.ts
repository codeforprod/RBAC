...
export interface IUserRoleService {
     ...
     * ```
     */
    getUserRoleAssignments(userId: string, organizationId?: string | null): Promise<IUserRoleAssignment[]>;
    /**
     ...
     * ```
     */
    getUserEffectivePermissions(userId: string, organizationId?: string | null): Promise<IUserPermissionResult>;
    /**
