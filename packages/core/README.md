...
# or
yarn add @holocron/rbac-core
# or
pnpm add @holocron/rbac-core
```
...
```typescript
import { InMemoryCache } from '@holocron/rbac-core';
...
```typescript
import { IRBACCache, ICacheSetOptions, ICacheGetOptions } from '@holocron/rbac-core';
...
```typescript
import { InMemoryAuditLogger, AuditAction } from '@holocron/rbac-core';
...
```typescript
// Wildcard Parser
import { WildcardParser, wildcardParser } from '@holocron/rbac-core';
...
// Permission Matcher
import { PermissionMatcher, permissionMatcher } from '@holocron/rbac-core';
...
import { RoleHierarchyResolver, hierarchyUtils } from '@holocron/rbac-core';
